...
const { registerAdmin, loginAdmin, forgotPassword, resetPassword, updateAdminProfile } = require("../controllers/adminController");
...
const { addSubCategory,getAllSubCategories,getSubCategoriesByParent,updateSubCategory, deleteSubCategory} = require("../controllers/subCategoryController");
...
router.put("/profile",adminAuth,upload.single("profileImage"),updateAdminProfile);
